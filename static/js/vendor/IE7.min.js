...
// scrollY,innerHeight
(function(){
    var polyInnerHeight = function(){
        window.innerHeight = (document.documentElement || document.body.parentNode || document.body).clientHeight;
    };

    var polyScrollY = function(){
        window.scrollY = (document.documentElement || document.body.parentNode || document.body).scrollTop;
    };

    if (window.innerHeight == undefined) {
        window.onresize = polyInnerHeight;
        polyInnerHeight();
    }

    if (window.scrollY == undefined) {
        window.onscroll = polyScrollY;
        polyScrollY();
    }
